...
The project now compiles correctly, parses JSON asynchronously and displays in tableView without any lag or missing cells. If I were allowed to use third party libraries, I'd use PINRemoteImage or SDWebImage for downloading image asynchronously. Likewise, I'd use an alternative of SwiftyJSON for Objective-C to better deal with JSON.
